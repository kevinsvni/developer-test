                ...
                <div class="card-body">
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('lessons') }}">Complete a Lesson</a>
                            </td>
                        </tr>
                        <tr>
                            <td>You have written 0 comments.</td>
                            <td> 
                                <a href="url">Write a comment</a>
                            </td>
                        </tr>
                    </table>
            ...
            <!-- <section class="py-5 py-xl-8">
                <div class="container">
                    ...
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                        <h2 class="mb-1 display-5 text-center">A  C  H  I  E  V  E  M  E  N  T  S</h2>
